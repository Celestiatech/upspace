...
export function FloorDirectory({
  ...
  return (
    <div className={`w-full max-w-7xl mx-auto px-4 sm:px-6 pt-20 pb-16 transition-colors min-h-screen ${
      ...
      <div className={`overflow-x-auto rounded-2xl border shadow-xl backdrop-blur-xl ${
            ...
            {filteredFloors.map((floor) => {
              ...
              return (
                ...
                >
                  ...
                  {/* ELEVATION */}
                  <td className="py-4 px-4 font-mono font-bold text-slate-800 dark:text-slate-300 text-xs">
                  ...
                  {/* CATEGORY */}
                  <td className="py-4 px-4 hidden md:table-cell text-slate-800 dark:text-slate-200">
                    <span className="px-2.5 py-1 rounded-md bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-xs font-bold text-slate-800 dark:text-slate-200">
                      {floor.category}
                    </span>
                  </td>
                  ...
                  <td className="py-4 px-4 hidden lg:table-cell font-mono font-black text-slate-950 dark:text-white">
                    <div className="flex items-center gap-1.5">
                      <Eye className="w-3.5 h-3.5 text-slate-700 dark:text-cyan-400" />
                      <span>{((floor.impressionsWeekly || 140000) / 1000).toFixed(0)}k/wk</span>
                    </div>
                  </td>

                  {/* CLICKS */}
                  <td className="py-4 px-4 hidden sm:table-cell font-mono font-black text-emerald-700 dark:text-emerald-400">
                    <div className="flex items-center gap-1.5">
                  ...
                  <td className="py-4 px-4 text-right" onClick={(e) => e.stopPropagation()}>
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-3.5 py-2 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-black text-xs shadow-sm transition active:scale-95"
                    >
      ...
      <div className="mt-8 p-4 rounded-2xl border text-center text-xs font-bold text-slate-800 dark:text-slate-300 border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-transparent">
