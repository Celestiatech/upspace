      ...
      <div
        className={`max-w-7xl mx-auto flex items-center justify-between backdrop-blur-xl rounded-2xl px-4 sm:px-6 py-2.5 shadow-2xl transition-all duration-300 ${
          isDay
            ...
            : 'bg-slate-950/80 border border-white/10 shadow-black/40 text-white'
        }`}
      >
        {/* LOGO */}
        <div
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span
                className={`text-[9px] uppercase tracking-widest font-mono px-1.5 py-0.5 rounded border ${
                  isDay
                    ? 'bg-cyan-100/70 text-cyan-800 border-cyan-300'
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          {user ? (
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs sm:text-sm font-medium transition border ${
                isDay
          ...
          >
            ...
            <ArrowUpRight className="w-3.5 h-3.5 text-slate-950/70 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
          </button>
        </div>
      </div>
    </header>
