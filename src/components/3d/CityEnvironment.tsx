  ...
  return (
    <group position={[0, 0, 0]}>
      ...
      <mesh position={[0, 0.08, 0]} rotation={[-Math.PI / 2, 0, 0]} receiveShadow>
        <ringGeometry args={[179, 179.55, 160]} />
        <meshStandardMaterial
      ...
      <mesh position={[0, 0.075, 0]} rotation={[-Math.PI / 2, 0, 0]} receiveShadow>
        <ringGeometry args={[22.25, 22.7, 96]} />
      ...
      {streetLightPositions.map(([lx, lz], i) => (
        <group key={`light-${i}`} position={[lx, 0, lz]}>
          ...
          <mesh position={[0, 2.8, 0.25]} rotation={[Math.PI / 4, 0, 0]}>
            <cylinderGeometry args={[0.03, 0.03, 0.6, 8]} />
            <meshStandardMaterial color={isDay ? '#64748b' : '#1e293b'} metalness={0.9} />
          </mesh>
          <mesh position={[0, 2.95, 0.45]}>
        ...
        <group key={`ped-${i}`} position={[p.x, 0, p.z]}>
          {[-0.055, 0.055].map((x) => (
            <mesh key={x} position={[x, 0.22, 0]} castShadow>
              <capsuleGeometry args={[0.045, 0.32, 6, 8]} />
              <meshStandardMaterial color="#1e293b" roughness={0.82} />
            </mesh>
          ))}
          <mesh position={[0, 0.54, 0]} castShadow>
            <cylinderGeometry args={[0.1, 0.13, 0.34, 8]} />
          ...
          <mesh position={[0, 0.975, -0.015]} scale={[1.03, 0.46, 1.04]} castShadow>
            <sphereGeometry args={[0.1, 12, 8]} />
            <meshStandardMaterial color={['#1c1917', '#713f12', '#0f172a'][i % 3]} roughness={0.9} />
          </mesh>
        </group>
      ))}
    </group>
